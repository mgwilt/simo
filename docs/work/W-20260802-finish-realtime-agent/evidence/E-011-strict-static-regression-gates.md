...
- Base revision: `4672689f130020b7805f669dd3fc01dbd94bcd43`; published implementation revision: `6907ee559664d1b443dab35c1f9ac65f0f22fa56`.
...
Proves: the frozen quality tools and their repository configuration are executable at the recorded revision; all declared job bodies pass; new strict BasedPyright diagnostics fail beyond the explicit baseline; Ruff and `ty` remain baseline-free gates; pre-push covers native and Python execution checks.

Does not prove: remote publication, that another checkout has installed Git hook files, that the 470 baseline diagnostics are resolved, human microphone or conversation behavior, deployment, or behavior on another platform.

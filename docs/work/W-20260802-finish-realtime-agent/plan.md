...
simo:
  ...
  work:
    ...
    updated_at: 2026-08-03T00:47:24Z
    ...
    next_action: Implement the Qwen3-TTS MLX-Audio streaming adapter, PCM framing, cancellation, and interruption behavior without loading model weights.
    blocker: null
---

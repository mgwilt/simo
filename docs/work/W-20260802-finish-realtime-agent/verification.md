...
- Model-weight execution, audio I/O, interruption/cancellation, latency, and operational readiness remain unverified. The bounded causal mailbox covers part, but not all, of `A-004`; `A-006` remains open pending model execution.

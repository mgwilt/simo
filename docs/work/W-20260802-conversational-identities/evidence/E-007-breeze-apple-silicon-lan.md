...
- Source state: uncommitted implementation based on `f5a039f5fa23877dc2aa39b234280b00c8909c6c`; official Breeze source pinned at `0072588a517f54a3a91d8f566be91cce74b64d13`; model pinned at `799624c0b4a1daa8db6d28bbd9850043c0270734`.
...
- Integration method: Simo runs the pinned upstream model in an isolated service environment bound to `127.0.0.1:7860`. The wrapper forces the nested text encoder to eager attention and uses the model's official eager generation path because upstream's HTTP runtime is CUDA-only. It does not edit `vendor/breeze-tts`. The in-process LiveKit TTS adapter consumes bounded 16-bit PCM and supports cancellation between returned chunks.

...
simo:
  ...
  work:
    ...
    updated_at: 2026-08-03T04:38:18Z
    ...
    next_action: Give every active alias/conversation an isolated Flecs world and expose bounded immutable snapshots carrying stable alias, conversation, and participant identity.
    blocker: null
---

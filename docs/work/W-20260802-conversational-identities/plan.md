...
simo:
  ...
  work:
    ...
    updated_at: 2026-08-03T16:17:35Z
    ...
    next_action: Remove the now-replaced Pipecat runtime, dependency, tests, documentation claims, and vendored submodule while preserving deterministic model, Flecs, persistence, privacy, and LiveKit coverage.
    blocker: null
---
